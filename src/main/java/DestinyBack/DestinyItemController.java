...
public class DestinyItemController {
    ...
    public DestinyItem[] getItemsByItemType(@RequestParam int item_type) throws JsonProcessingException {
        return itemHelper.getItems(item_type);
    }

    @GetMapping("/item")
    @RequestMapping(value="/item", params="display_name")
    public DestinyItem[] getItemsByDisplayName(@RequestParam String display_name) throws JsonProcessingException {
